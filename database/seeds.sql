...
('Carlos Herrera',   'c.herrera@gymfit360.com',   '3001234567', 'Crossfit y Funcional',       1,  '2022-01-15'),
('María González',   'm.gonzalez@gymfit360.com',  '3109876543', 'Yoga y Pilates',              1,  '2022-03-01'),
('Andrés Morales',   'a.morales@gymfit360.com',   '3207654321', 'Musculación y Powerlifting', 1,  '2021-06-10'),
('Laura Jiménez',    'l.jimenez@gymfit360.com',   '3151112233', 'Spinning y Cardio',           0, '2020-09-20'),
('Roberto Castillo', 'r.castillo@gymfit360.com',  '3004445566', 'Natación y Acuaerobic',       0, '2021-11-05');
...
(1, 2, '2025-02-01', '2025-05-02', 1),   -- Juan: Trimestral activa
(2, 1, '2025-04-15', '2025-05-15', 1),   -- Sofía: Mensual activa
(3, 4, '2025-01-01', '2026-01-01', 1),   -- Diego: Anual activa
(6, 1, '2025-04-20', '2025-05-20', 1),   -- Camila: Mensual activa
(7, 3, '2025-01-01', '2025-07-01', 1),   -- Mateo: Semestral activa
-- Membresías PRÓXIMAS A VENCER (dentro de 7 días desde hoy)
(4, 1, CURRENT_DATE - INTERVAL 23 DAY, CURRENT_DATE + INTERVAL 4 DAY, 1),  -- Valentina: vence en 4 días
(5, 1, CURRENT_DATE - INTERVAL 26 DAY, CURRENT_DATE + INTERVAL 2 DAY, 1),  -- Sebastián: vence en 2 días
-- Membresías VENCIDAS
(8, 1, '2025-01-05', '2025-02-05', 0),  -- Isabella: vencida (inactiva)
(9, 2, '2024-10-01', '2024-12-31', 0),  -- Samuel: vencida (inactiva)
(10, 1, '2024-12-01', '2024-12-31', 0); -- Luciana: vencida (inactiva)
